...
public class SnakeMain extends JFrame implements KeyListener {
    ...
    public char getDirecao() {
        if      (ultimaTecla == KeyEvent.VK_W)    return 'C';  // Cima
        else if (ultimaTecla == KeyEvent.VK_D) return 'D';  // Direita
        else if (ultimaTecla == KeyEvent.VK_S)  return 'B';  // Baixo
        else if (ultimaTecla == KeyEvent.VK_A)  return 'E';  // Esquerda
